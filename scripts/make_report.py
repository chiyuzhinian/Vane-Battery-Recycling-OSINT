...
def _gap_log() -> list[str]:
    ...
    L += ["### 10.4 欧美覆盖面的本轮扩充（优先欧美政策法规采集）", "",
          ...
          "| `32025D0840` / `32025D1174` | 委员会决定：承认某些关键原材料 | "
          "直接决定黑粉的**战略价值认定** |",
          "| `32025R2194` | 实施条例（关键原材料） | 单一机制 |",
          "| `32020L0362` / `32020L0363` / `32023L0544` | 授权指令修订 ELV 附件 II | "
          "报废车**拆解与去污**的具体要求 |",
    ...
    L += ["#### 🇺🇸 美国：机构 4 → 15 个，关键词 20 → 27 个，配对 30 → 37 组", "",
